...
(function() {
  var BDP, app, bodyParser, checkUserLogined, config, cookieParser, db, dbPath, express, fs, logErr, orm, router, utils, uuid;
  ...
  router.post("/a/login", function(req, res) {
    ...
    return bdp.refreshToken(function(err) {
      ...
      return bdp.login(username, password, codeString, captcha, function(err) {
        ...
        return bdp.getUserInfo(function(err, info) {
          var Users;
          if (err) {
            return onLoginEnd(err);
          }
